...
export class GratkaCollector extends BaseCollector {
  async detail(offer) {
  ...
  async listing() {
    const defaultSearch = [
      'https://gratka.pl/nieruchomosci/mieszkania/sprzedaz',
      'https://gratka.pl/nieruchomosci/dzialki-grunty/sprzedaz',
    ];
    ...
    return items.map((it) => ({
      ...
      offer_type: 'sale',
      property_type: it.property_type || 'plot',
      country: 'Poland',
      region: it.region,
      city: it.city,
